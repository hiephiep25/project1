...
if(isset($_POST['themsanpham'])){
    //them
    $sql_them = "INSERT INTO tbl_tensanpham(tensanpham,masp,giasp,soluong,hinhanh,tomtat,noidung,tinhtrang,id_danhmuc)  
    ...
    $sql_update = "UPDATE tbl_tensanpham SET tensanpham='".$tensanpham."', masp='".$masp."', giasp='".$giasp."',
    ...
    //xoa hinh anh cu
    $sql = "SELECT * FROM tbl_tensanpham WHERE id_sanpham= '$_GET[id_sanpham]' LIMIT 1";
    ...
    $sql_xoa = "DELETE FROM tbl_tensanpham WHERE id_sanpham='".$id."'";
